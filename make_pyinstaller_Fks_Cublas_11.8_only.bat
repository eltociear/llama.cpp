cd /d "%~dp0"
copy "P:\NVIDIAGPUCT\CUDA\v11.8\bin\cudart64_110.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v11.8\bin\cublasLt64_11.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v11.8\bin\cublas64_11.dll" .\ /Y
